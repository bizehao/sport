package com.sport.view.dashBoard;
...
import com.sport.R;
import com.sport.view.util.PxUtils;
import com.sport.view.util.SpringInterpolator;
import com.sport.view.util.StringUtil;
/**
...
public class DashboardView extends View {
    ...
    private RectF rectF1, rectF2; //矩形
    ...
    TimeInterpolator interpolator = new SpringInterpolator(); //动画
